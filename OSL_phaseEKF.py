...
try:
    ...
    for i in range(3):
        ...
        knee_buffer.append(dataOSL['kneJoiPos'] * 180 / np.pi)
        ankle_buffer.append(dataOSL['ankJoiPos'] * 180 / np.pi)
    #===================================================================================================================
    ...
    while True:
        ...
        # 2) Use the buffers
        knee_buffer = [dataOSL['kneJoiPos'][0] * 180 / np.pi, knee_buffer[0], knee_buffer[1]]
        ankle_buffer = [dataOSL['ankJoiPos'][0] * 180 / np.pi, ankle_buffer[0], ankle_buffer[1]]

        knee_angle = np.median(knee_buffer)
        ankle_angle = np.median(ankle_buffer)
        
        dataOSL['kneJoiPos'][0] = knee_angle
        dataOSL['ankJoiPos'][0] = ankle_angle
        #==========================================================================================================
        ...
        # 1) Global thigh angle
        global_thigh_angle = dataOSL['ThighSagi'][0] * 180 / np.pi

        # 2) Global thigh angle velocity 
        if ptr == 0:
