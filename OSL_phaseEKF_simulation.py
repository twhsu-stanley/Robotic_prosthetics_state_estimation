...
try:
    ...
    plt.subplot(411)
    plt.plot(dataOSL["Time"], simulation_log['phase_est'])
    plt.plot(dataOSL["Time"], dataOSL['PV'] / 998)
    plt.legend(('EKF phase', '998 PV'))
    plt.subplot(412)
    plt.plot(dataOSL["Time"], simulation_log['phase_dot_est'])
    plt.subplot(413)
    plt.plot(dataOSL["Time"], simulation_log['step_length_est'])
    plt.subplot(414)
    plt.plot(dataOSL["Time"], simulation_log['ramp_est'])

    plt.figure("Global Thigh Angle")
    plt.subplot(311)
