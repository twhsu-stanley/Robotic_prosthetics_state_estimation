...
try:
    ...
    # for live plotting
    start_time = time.time() 	# for determining lag between sender sending data and receiver plotting data
    ptr=0
    ...
    while True:
        ...
        #    GlobThighVel = 0 
        #else:
        #    GlobThighVel = (GlobThighY - GlobThigh_0) / dt
        #    # low-pass filtering
        #    GlobThighVel_lp, z_lp = lfilter(b_lp, a_lp, GlobThighVel, zi = z_lp) # low-pass filtering
        #loops += 1
        #GlobThigh_0 = GlobThighY

        ## Compute atan2
        # band-pass filtering
        #GlobThigh_bp, z_bp = lfilter(b_bp, a_bp, GlobThighY, zi = z_bp) 
